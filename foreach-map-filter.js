...
function showFirstAndLast(arr){
    ...
    arr.forEach(function(first){
        newArray.push(first[0]+first[first.length-1]);
...
function vowelCount(str){
        ...
        newArr.forEach(function(letter) {
          ...
          if (vowels.indexOf(lowerCasedLetter) !== -1) {
            if (elm[lowerCasedLetter]) {
              elm[lowerCasedLetter]++;
            } else {
             elm[lowerCasedLetter] = 1;
            }
          }
        });
        return elm;
...
/*
Write a function called find which accepts an array and a value and returns the first element in the array that has 
